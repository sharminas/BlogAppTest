    ...
    <div class="container">
      <div class="row">
        ...
        <?php endif;?>
        <div class="paging pull-right paginate">
          <?php echo $this->Paginator->prev('<< ' . __('previous'), array() , null,  array('actions' => 'prev_next')); ?>
          &nbsp; 
          <?php echo $this->Paginator->next(__('next') . ' >>', array(), null, array('actions' => 'prev_next'));?> 
        </div>
         <!-- <p class="pull-right paginate"><?php //echo $this->Html->link(__('Older Post>>'),array('controller' => 'articles','action' =>'index')); ?></p> --> 
        </div>&nbsp;&nbsp; &nbsp; 
