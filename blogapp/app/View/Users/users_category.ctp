  ...
  <div class="row well">
   ...
   <div class="col-sm-9 col-md-8 main">
    <?php foreach ($user['Category'] as $category): ?>      
        <div class="blog-post well" style="text-align:center;" id="content">
          <div class="blog-post-title">
            ...
            <h2> <?php echo $this->Html->link($category['title'],array('controller' => 'categories','action' =>'view',$category['id']));?>
            </h2>
          </div>      
          <div class="blog-post-meta">
             <?php echo $this->Html->tag('span',$this->Text->truncate($category['description'],-1));?>
          </div>
          <p><?php echo $this->Html->link(__('Continue Reading...'),array('controller' => 'categories','action' =>'view',$category['id'])); ?></p>
        </div>
        <?php endforeach;?>
    </div>
  </div>
