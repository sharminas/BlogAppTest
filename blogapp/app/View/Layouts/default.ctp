...
<body>
         ...
         <div class="head"> 
          <ul class="nav navbar-nav">
           <li class="dropdown">
             ...
             <!--   <p class="demo"></p>
                <select class="selection" id="myselect">
                    <option><?php //echo 'ENG'?> </option>
                    <option><?php //echo 'POR'?></option>
                    <option><?php //echo 'FRA'?></option>
                </select>   --> 
           </li>     
           <li class="fb"><?php echo $this->Html->link(__('<span class="fa fa-facebook-official"> </span>'), '#',array('escape' => false));?></li>
            <li class="gmail"><?php echo $this->Html->link(__('<span class="fa fa-google-plus"> </span>'), '#', array('escape' => false));?></li>
            <li class="pin"><?php echo $this->Html->link(__('<span class="fa fa-pinterest"> </span>'),"#",array('escape' => false));?> </li>
            <li class="tmblr"><?php echo $this->Html->link(__('<span class="fa fa-tumblr"> </span>'),"#",array('escape' => false));?></li>
            <li class="yt"><?php echo $this->Html->link(__('<span class="fa fa-youtube"> </span>'),"#",array('escape' => false));?></li>
            <li class="twitter"><?php echo $this->Html->link(__('<span class="fa fa-twitter"> </span>'),"#",array('escape' => false));?></li>
          </ul>
          <ul class="nav navbar-nav navbar-right">
            <li class="dropdown">
              <div style="margin-top: .3cm;">
                <input type="text" name="TextBox" id="TextBox" class="text" value=""/>
            ...
            <li>
              <?php if(AuthComponent::user('id')): ?>
                <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><?php echo AuthComponent::user('firstname')?>
  ...
  <div class="jumbotron" style="background-color:white;border:none;">
    <hr style="border: 1px solid #DCDCDC">
      <h2 id="home" class="title">BLOGAPP</h2>
        <p style="font-size: 10px; color: black; text-align:center;">A blog (a truncation of the expression weblogis a discussion or informational site published on the World Wide Web.</p>
    <hr style="border: 1px solid #DCDCDC">
            ...
            <div class="col-sm-offset-3 col-md-8">
                <div class="menu">
                  <ul class="nav navbar-nav">
                      ...
                      <li><?php echo $this->Html->link(__('Contact'), array('controller' => 'users','action' => 'add'))?>
                      </li>
                  </ul>
                </div>
              </div>
