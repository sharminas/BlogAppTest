...
class UsersController extends AppController {
    ...
    protected function _setupAuth() {
		...
		$this->Auth->allow('add', 'index','reset', 'verify', 'logout', 'reset_password', 'login', 'resend_verification');
	...
	public function request_new_password($token = null) {
		...
		$this->Session->setFlash( 'There was an error verifying your account. Please check the email you were sent, and retry the verification link.');
		$this->redirect('/');
	}
